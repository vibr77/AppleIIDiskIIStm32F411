...
enum page{FS,MOUNT,MENU,DISKIIIMAGE,FAVORITES,SETTINGS,EMULATIONTYPE,IMAGEMENU,SMARTPORT,SMARTPORT_IMAGEOPTION,SMARTPORT_IMAGEOPTIONLV2, SMARTPORT_MOUNT,MAKEFS,DIROPTION,NEWIMAGE,FSLABEL,FSSELECTIMAGE};
