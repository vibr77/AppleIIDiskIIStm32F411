...
void HardFault_Handler(void)
{
  ...
  log_error("hard fault endless loop");
...
void EXTI0_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(STEP0_Pin);
...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(STEP1_Pin);
...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(STEP2_Pin);
...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(DEVICE_ENABLE_Pin);
